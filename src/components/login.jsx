    ...
    <div className='w-full h-screen relative'>
        ...
        <div className="absolute top-[20%] left-[8%] md:left-[35%] bg-black h-[500px] w-[350px]  m-auto text-white">
            ...
            <h2 className="text-white p-3 text-3xl text-left">Sign In</h2>
                ...
                <div className="m-3"><button className="bg-transparent border p-2 w-[300px] rounded flex items-center justify-center gap-3"><FcGoogle/> Sign in With Google</button></div>
